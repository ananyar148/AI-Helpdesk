  ...
  await send({
    ...
    html: base(`
      ...
      <p style="color:#475569;margin:0 0 20px;">
        We've logged your request and our AI has routed it to the right team.
      ...
      <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:16px;margin-bottom:20px;">
        ...
        <p style="margin:0 0 14px;font-size:15px;font-weight:600;color:#1e293b;">${ticket.subject}</p>

        <div style="display:flex;gap:8px;flex-wrap:wrap;">
          ${pill(ticket.category, { bg: '#ede9fe', text: '#6d28d9' })}
          ${pill(ticket.priority, priorityColor(ticket.priority))}
          ${pill(teams + ' Team', { bg: '#dbeafe', text: '#1d4ed8' })}
        </div>
      </div>
      ...
      <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:14px;margin-bottom:20px;">
        ...
        <p style="margin:6px 0 0;font-size:12px;color:#16a34a;">Save this ID to track your ticket status.</p>
      </div>

      ${ticket.draftResponse ? `
      <div style="border-left:3px solid #2563eb;padding-left:14px;margin-bottom:20px;">
        <p style="margin:0 0 6px;font-size:12px;color:#2563eb;font-weight:600;text-transform:uppercase;">🤖 AI Draft Response</p>
        <p style="margin:0;color:#334155;font-size:14px;font-style:italic;">${ticket.draftResponse}</p>
      </div>` : ''}

      <p style="color:#64748b;font-size:13px;margin:0;">
        If you have additional information, please submit a new ticket referencing ID <code>${ticket.id}</code>.
      </p>
    `),
  });
}
...
export async function sendTicketResolvedClient(ticket) {
  ...
  await send({
    ...
    html: base(`
      ...
      <p style="color:#475569;margin:0 0 20px;">
        Great news — the ${teams} team has marked your ticket as resolved.
      </p>
      ...
      <p style="color:#64748b;font-size:13px;margin:0;">
        If your issue persists, please submit a new ticket referencing ID <code>${ticket.id}</code>.
      </p>
    `),
  });
}
