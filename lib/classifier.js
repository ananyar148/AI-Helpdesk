...
const RULES = [
  {
    phrases: [
      ...
      'subscription cancelled', 'invoice payment', 'invoice issue', 'invoice problem',
      'invoice related', 'billing issue', 'billing problem', 'billing query',
      'pay for', 'charged for', 'invoice',
    ],
  ...
  },
  {
    phrases: [
      ...
      'broken', 'not responding', 'keeps freezing', 'freezes', 'application freezes',
      'page freezes', 'becomes blank', 'goes blank', 'not opening',
  ...
  if (aiResult) {
    if (needsFullClassification) {
      ...
      return {
        ...
        source:          'vertex-ai',
        confidenceScore: custom.confidence, // rule-based score (low — that's why AI took over)
      };
    }
