...
export function buildGoogleAIClient() {
  ...
  // Update the fallback to default to global
  ...
  const ai = new GoogleGenAI({
    ...
    project,
    location,
    // Fix the SDK routing error for the global endpoint
    httpOptions: location === 'global' ? { baseUrl: 'https://aiplatform.googleapis.com' } : {},
    googleAuthOptions: {
      credentials,
